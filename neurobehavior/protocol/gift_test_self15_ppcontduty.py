...
from neurobehavior.protocol import ProtocolGiftTestPPContDuty


class ProtocolGiftTestSelf15PPContDuty(ProtocolGiftTestPPContDuty):
    name = "GiftStimTestSelf15PPContDuty"
    params = dict(
